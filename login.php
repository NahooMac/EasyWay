...
<body>
  ...
  <div class="navbar-list">
    ...
    <li><a href="about.php"> <img src="css/img/about.png" width="20" alt="" srcset="">About</h4> </a></li>
        <li><a href="about.php"><img src="css/img/contact.png" width="20" alt="" srcset="">Contact</h4></a></li>
        <li><a href="about.php"><img src="css/img/privcy.png" width="20" alt="" srcset="">Privcy And Term</h4></a></li>
        <li><a href="login.php"><img src="css/img/login (1).png" width="20" alt="" srcset="">login</h4></a></li>
    </ul>
    </ul>
  </div> 
     <?php
...
?>
        <div class="loginform"><img src="css/img/user.png" alt="" srcset="">
            <h2>Login To Your Account</h2><hr><br>
