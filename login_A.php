...
?>
        <div class="loginform"><img src="css/img/user.png" alt="" srcset="">
           ...
           <br> <input type="submit" value="SignIn" class="btn-login" name="btnlogin">
                 ...
                 Goto Doctors <a href="Doc_login.php" class="Sign">SignIn</a> page<br>
                 Goto Nurse <a href="Nur_login.php" class="Sign"> SingIn</a> page <br>
                Goto Staff  <a href="Staff_login.php" class="Sign"> SingIn</a> page <br>
              </div>
